...
---
## Introduction
With the recent news of discord implementing age verification, one might want to switch to matrix. This guide serves to help you connect your matrix and discord communities. We will be using https://t2bot.io/discord/ for this as it is the most straightforward solution.

## Creating a matrix account
Go to https://app.element.io/#/register and create a matrix account, use the default homeserver matrix.org. Afterwards, enter your account details and you should be logged in.
...
Go to https://t2bot.io/discord/, click on the link shown below, this will create a room with you and the bot.
...
In the address bar there should be a URL like https://discordapp.com/channels/ServerID/ChannelID - use that as a reference to say in your Matrix room !discord bridge ServerID ChannelID. (https://t2bot.io/discord/).  

![screenshot of bridge command](assets/posts/post3/post3_img7_bridgecommand.png)
