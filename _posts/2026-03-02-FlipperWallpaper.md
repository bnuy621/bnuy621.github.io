...
description: Guide to making a flipper zero wallpaper
toc: true
---
## Introduction
...
First step will be selecting a wallpaper, in this case i chose an elysia live wallpaper.
...
Thirdly, resize the wallpaper to be 128 x 64 so it fits on the flipper screen.
...
Now, split the gif into indivual images. Take note of the end and start time as it is not set to the full length of the video by default.  Afterwards, download the frames as ZIP and extract it.
...
Run qflipper, drag the folder and manifest.txt into the flipper. Upon rebooting the flipper your animation should now be playing.
![screenshot of qflipper](assets/posts/post2/post2_img15_flipper.png)
